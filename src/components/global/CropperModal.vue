                                ...
                                <div class="flex flex-wrap my-4">
                                    ...
                                    <div class="mb-3 w-full">
                                        <input class="form-control block w-full px-3 py-1.5 text-base 
                                                        ...
                                                        focus:outline-none" type="file" id="image" ref="fileInput" />
                                    </div>
                                </div>
                                <div class="pb-3 flex flex-row-reverse px-4">
                                    <button type="button" class="inline-flex w-full justify-center rounded-md border
                                            border-transparent bg-blue-600 px-4 py-2 text-white text-base
                                            font-medium shadow-sm hover:bg-blue-700 focus:outline-none
                                            focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ml-3 w-auto text-sm">
                                        Crop Image
                                    </button>
                                    <button type="button" class="inline-flex w-full justify-center rounded-md border
                                                border-transparent bg-red-600 px-4 py-2 text-white text-base
                                                font-medium shadow-sm hover:bg-red-700 focus:outline-none
                                                focus:ring-2 focus:ring-red-500 focus:ring-offset-2 ml-3 w-auto text-sm">
                                        Cancel
                                    </button>
                                </div>
                            </div>
